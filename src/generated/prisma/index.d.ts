...
export namespace Prisma {
  ...
  */
  ...
  export type todoListOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "completed" | "created_at", ExtArgs["result"]["todoList"]>
  ...
  interface todoListFieldRefs {
    ...
    readonly completed: FieldRef<"todoList", 'Boolean'>
    readonly created_at: FieldRef<"todoList", 'DateTime'>
  }
  ...
  export type todoListWhereInput = {
    ...
    completed?: BoolFilter<"todoList"> | boolean
    created_at?: DateTimeFilter<"todoList"> | Date | string
  }
  ...
  export type todoListScalarWhereWithAggregatesInput = {
    ...
    completed?: BoolWithAggregatesFilter<"todoList"> | boolean
    created_at?: DateTimeWithAggregatesFilter<"todoList"> | Date | string
  }
